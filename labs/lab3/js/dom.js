...
var run = setInterval(drawNebulae, 1000000);
function startInterval() {
    run = setInterval(drawNebulae, 1);
}
...
$(document).on('mouseover','#myCanvas',startInterval);
$(document).on('mouseout','#myCanvas',stopInterval);